...
public class XYZTransformerUI implements TransformerUI {

    public Icon getIcon() {
        return new ImageIcon(getClass().getResource("/org/gephi/ui/ranking/plugin/resources/xyz.png"));
    }

    public String getName() {
        return NbBundle.getMessage(SizeTransformerUI.class, "XYZTransformerUI.name");
    }
